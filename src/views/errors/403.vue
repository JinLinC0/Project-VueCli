<template>
    <div
        class="w-full h-full flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 overflow-hidden">
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
            <p class="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-gray-300">403</p>
            <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300 mt-2">页面不存在</p>
            <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">抱歉，您要查找的页面无法访问</p>
            <router-link to="/"
